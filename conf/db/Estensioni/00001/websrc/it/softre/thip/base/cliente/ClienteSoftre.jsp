...
<%
  ...
  WebForm ClienteSoftreForm =  
     new com.thera.thermfw.web.WebForm(request, response, "ClienteSoftreForm", "ClienteSoftre", null, "com.thera.thermfw.web.servlet.FormActionAdapter", false, false, true, true, true, true, null, 0, true, "it/softre/thip/base/cliente/ClienteSoftre.js"); 
