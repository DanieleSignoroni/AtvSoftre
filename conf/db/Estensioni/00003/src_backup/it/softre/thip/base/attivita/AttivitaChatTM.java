...
public class AttivitaChatTM extends TableManager {
  ...
  /**
   * Attributo R_ATTIVITA_SOFTRE
   */
  public static final String R_ATTIVITA_SOFTRE = "R_ATTIVITA_SOFTRE";
  ...
  protected void initializeRelation() throws SQLException {
    ...
    addAttribute("IdAttivitaSoftre", R_ATTIVITA_SOFTRE, "getIntegerObject");
    addAttribute("Id", ID, "getIntegerObject");
    addAttribute("IdAzienda", ID_AZIENDA);
    
    addComponent("DatiComuniEstesi", DatiComuniEstesiTTM.class);
    setKeys(ID_AZIENDA + "," + R_ATTIVITA_SOFTRE + "," + ID);
  ...
  private void init() throws SQLException {
    configure(MESSAGE + ", " + R_ATTIVITA_SOFTRE + ", " + ID + ", " + ID_AZIENDA
