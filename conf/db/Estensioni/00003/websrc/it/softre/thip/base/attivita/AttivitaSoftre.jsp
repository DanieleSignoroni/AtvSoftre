<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN"
                      "file:///W:\PthDev\Projects\Panthera\AtvSoftre\WebContent\dtd/xhtml1-transitional.dtd">
<html>
...
%>
              ...
              <div class="tabbed_page" id="<%=mytabbed.getTabPageId("tab4")%>" style="width:100%;height:100%;overflow:auto;"><% mytabbed.startTab("tab4"); %>
                <table style="width: 100%;">
                  <tr>
                    <td valign="top">
                      <%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "AttivitaSoftre", null, null); 
   label.setParent(AttivitaSoftreForm); 
%><label class="<%=label.getClassType()%>" for="AttivitaCollaboratori"><%label.write(out);%></label><%}%>
                  ...
                  <tr>
                    <td valign="top">
                      <!--<span class="ajaxgrid" id="AttivitaCollaboratori">--><% 
  WebAjaxGrid AttivitaSoftreAttivitaCollaboratori =  
     new com.thera.thermfw.web.WebAjaxGrid("AttivitaSoftre", "AttivitaCollaboratori", 10, new String[]{"IdUtente", "IdAttivitaSoftre", "IdAzienda", "Azienda.Descrizione", "Utente.DatiComuni.IdUtenteCrz"}, "independent" , null, true, null,null,"A"); 
 ...
 AttivitaSoftreAttivitaCollaboratori.setOrderByClassAD(null); 
 AttivitaSoftreAttivitaCollaboratori.setOrderByWay("A"); 
 ...
 AttivitaSoftreAttivitaCollaboratori.addHidden("IdAzienda"); 
...
%><label class="<%=label.getClassType()%>" for="AttivitaFixes"><%label.write(out);%></label><%}%>
                  ...
                  <tr>
                    <td valign="top">
                      <!--<span class="ajaxgrid" id="AttivitaFixes">--><% 
  WebAjaxGrid AttivitaSoftreAttivitaFixes =  
     new com.thera.thermfw.web.WebAjaxGrid("AttivitaSoftre", "AttivitaFixes", 10, new String[]{"IdAzienda", "IdFix", "Note", "Azienda.Descrizione", "Fix.IdCliente"}, "independent" , null, true, null,null,"A"); 
 AttivitaSoftreAttivitaFixes.setParent(AttivitaSoftreForm); 
 AttivitaSoftreAttivitaFixes.setNoControlRowKeys(false); 
 AttivitaSoftreAttivitaFixes.setOrderByClassAD(null); 
 AttivitaSoftreAttivitaFixes.setOrderByWay("A"); 
 AttivitaSoftreAttivitaFixes.addHideAsDefault("Fix.IdCliente"); 
 AttivitaSoftreAttivitaFixes.addHideAsDefault("Azienda.Descrizione"); 
 AttivitaSoftreAttivitaFixes.addHidden("IdAzienda"); 
                ...
                <table style="width: 100%;">
                  <tr>
                    <td valign="top">
                      <%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "AttivitaSoftre", null, null); 
   label.setParent(AttivitaSoftreForm); 
%><label class="<%=label.getClassType()%>" for="AttivitaChat"><%label.write(out);%></label><%}%>
                    </td>
                    <td valign="top">
                    </td>
                  </tr>
                  <tr>
                    <td valign="top">
                      <!--<span class="ajaxgrid" id="AttivitaChat">--><% 
  WebAjaxGrid AttivitaSoftreAttivitaChat =  
     new com.thera.thermfw.web.WebAjaxGrid("AttivitaSoftre", "AttivitaChat", 10, new String[]{"Id", "IdAttivitaSoftre", "IdAzienda", "Message", "Azienda.Descrizione"}, "independent" , null, true, null,null,"A"); 
 AttivitaSoftreAttivitaChat.setParent(AttivitaSoftreForm); 
 AttivitaSoftreAttivitaChat.setNoControlRowKeys(false); 
 AttivitaSoftreAttivitaChat.setOrderByClassAD(null); 
 AttivitaSoftreAttivitaChat.setOrderByWay("A"); 
 AttivitaSoftreAttivitaChat.addHideAsDefault("Azienda.Descrizione"); 
 AttivitaSoftreAttivitaChat.addHidden("IdAzienda"); 
 AttivitaSoftreAttivitaChat.write(out); 
%>
<!--</span>-->
                    </td>
                    <td valign="top">
